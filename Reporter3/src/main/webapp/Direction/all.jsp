								...
								<div class="nk-block nk-block-lg">
									<div class="nk-block-head">
										<div class="nk-block-head-content">
											<h4 class="nk-block-title">Toutes les actions de l'année : ${year}</h4>
										</div>
									</div>
											...
											<table id="table_id"
												...
												<thead>
													<tr class="nk-tb-item nk-tb-head">
														...
														<th class="nk-tb-col"><span class="sub-text">Théme</span></th>
														...
														<th class="nk-tb-col tb-col-lg"><span
															class="sub-text">Centre concerné</span></th>
														<th class="nk-tb-col tb-col-md"><span
												...
												<tbody>
													...
													for (Action a : actions) {
														...
														if(a.getStatus()==0){
															...
															status="Reporting éffectué";
														}else if(a.getStatus()==3){
															status="Action terminé";
														}
																	...
																	<div class="drodown">
																		...
																		<div class="dropdown-menu dropdown-menu-right">
																			<ul class="link-list-opt no-bdr">
																				<li><a href="Direction/Details?action=<%=a.getId()%>"><em class="icon ni ni-eye"></em><span>Détails</span></a></li>
