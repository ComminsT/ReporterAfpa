														...
														<form action="#" class="gy-3" data-parsley-validate="">
															<div class="row g-3 align-center">
																<div class="col-lg-5">
																	<div class="form-group">
																		<label class="form-label" for="site-name">Thème
															...
															<div class="row g-3 align-center">
																...
																<div class="col-lg-7">
																	<div class="form-group">
																		<div class="form-control-wrap">
																			<input value="<%=soussecteur%>" disabled
														...
														<div class="card-inner">
															<form method="POST" class="gy-3">
																...
																for (Canal_com_used cu : ccused) {
																	System.out.println("id types="+cu.getId_type());
																	System.out.println("id canalcom="+cu.getId_canal_com());
																	System.out.println("entrée boucle ccomused");	
																	int couverture = 0;
																	types = typedao.getById(cu.getId_type());
																	canal_com = canal_comdao.getById(cu.getId_canal_com());
												...
												<div class="nk-block nk-block-lg">
													...
													<%if(a.getStatus()==3){ %>
                                                            <div class="row g-3 align-center">
                                                                <div class="col-lg-5">
                                                                    <div class="form-group">
                                                                        <label class="form-label">Nombre de contacts rappelés :</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-7">
                                                                    <div class="form-control-wrap">
                                                            ...
                                                            <div class="row g-3 align-center">
                                                                <div class="col-lg-5">
                                                                    <div class="form-group">
                                                                        <label class="form-label">Nombre de contacts argumentés :</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-7">
                                                                    <div class="form-control-wrap">
                                                            ...
                                                            <div class="row g-3 align-center">
                                                                <div class="col-lg-5">
                                                                    <div class="form-group">
                                                                        <label class="form-label">Nombre d'inscriptions en évènement :</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-7">
                                                                    <div class="form-control-wrap">
