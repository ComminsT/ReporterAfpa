                                ...
                                <div class="nk-block nk-block-lg">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-content">
                                            <h4 class="title nk-block-title">Nouvelle action</h4>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="card-inner">
                                                            <form method="POST" class="gy-3">
                                                                <div class="row g-3 align-center">
                                                                    <div class="col-lg-5">
                                                                        <div class="form-group">
                                                                            <label class="form-label" for="site-name">Type d'action</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-7">
                                                                        <div class="g-4 align-center flex-wrap">
                                                                            ...
                                                                            <div class="g">
                                                                                <div class="custom-control custom-control-lg custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="type" checked id="customRadio5" value="1">
                                                                                    <label class="custom-control-label" for="customRadio5">Marketing</label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="g">
                                                                                <div class="custom-control custom-control-lg custom-radio">
                                                                                    <input type="radio" class="custom-control-input" name="type" id="customRadio6" value="2">
                                                                                    <label class="custom-control-label" for="customRadio6">Communication</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    <div class="col-lg-5">
                                                                        <div class="form-group">
                                                                            <label class="form-label" for="site-name">Thème de l'action</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-7">
                                                                        <div class="form-group">
                                                                            <div class="form-control-wrap">
                                                                                <input required name="input_theme" type="text" class="form-control" id="site-name" value="" placeholder="Ma nouvelle action">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="form-control-wrap">
                                                                            <select name="input_dispo" class="form-select form-control form-control-lg" data-search="on">
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="form-group">
                                                                            <div class="form-control-wrap">
                                                                                <select name="input_pmarche" class="form-select form-control form-control-lg" data-search="on">
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="form-group">
                                                                            <div class="form-control-wrap">
                                                                                <select name="input_ssecteur" class="form-select form-control form-control-lg" data-search="on">
                                                                                ...
                                                                                for(Sous_secteur ss : ssecteurs){%><option value="<%=ss.getId()%>"><%=ss.getTitre() %></option>
                                                                                    <%}%>
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="form-group">
                                                                            <div class="form-control-wrap">
                                                                                <select name="input_cible" class="form-select form-control form-control-lg" data-search="on">
                                                                                <%ArrayList<Cible>cibles=new ArrayList<Cible>();
                                                                                cibles=(ArrayList<Cible>)request.getAttribute("cibles");
                                                                                for(Cible c : cibles){%><option value="<%=c.getId()%>"><%=c.getTitre() %></option>
                                                                                    <%}%>
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    <div class="col-lg-5">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span class="form-note">Plusieurs choix possible</span>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-7">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    <select required name="centres" class="form-select" multiple="multiple" data-placeholder="Liste des centres">
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    <select required name="canal" class="form-select" multiple="multiple" data-placeholder="Liste des canaux">
                                                                        ...
                                                                        %>
                                                                            ...
                                                                            <li>
                                                                                <div class="custom-control custom-radio">
                                                                                    <input type="radio" class="custom-control-input" checked name="pos" value="<%=p.getId() %>" id="<%=p.getId()%>">
                                                                                    <label class="custom-control-label" for="<%=p.getId()%>"><%=p.getTitre() %></label>
                                                                                </div>
                                                                            </li>
                                                                            <%}%>
                                                                ...
                                                                <div class="row g-3 align-center">
                                                                    ...
                                                                    <div class="col-lg-7">
                                                                        <div class="form-group">
                                                                            <div class="form-control-wrap">
                                                                                <input required name="date" class="form-control date-picker datepicker " id="weeklyDatePicker">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row g-3">
                                                                    <div class="col-lg-7 offset-lg-5">
                                                                        <div class="form-group mt-2">
                                                                            <button name="bcreer" type="submit" class="btn btn-lg btn-primary">Créer</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </form>
